        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <?php if(is_array($role_data)): foreach($role_data as $key=>$role_data): ?><tr id="product1">
                        <td><?php echo ($role_data["id"]); ?></td>
                        <td><a href="#"><?php echo ($role_data["role_name"]); ?></a></td>
                        <td><?php echo ($role_data["status"]); ?></td>
                        <td style="text-align: center;"><a href="<?php echo U('accesslist',"id=$role_data[id]");?>">权限分配</a></td>
                        <td><a href="#">修改</a></td>
