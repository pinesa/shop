                ...
                <tr>
                    ...
                    <td>
                        <select name="brand_id">
                            <option value="0" >请选择</option>
                           <?php if(is_array($data)): foreach($data as $k=>$brand_data): if(is_array($brand_data)): foreach($brand_data as $key=>$list): ?><option value="<?php echo ($list["id"]); ?>"><?php echo ($list["brand_name"]); ?></option><?php endforeach; endif; ?>><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
