        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
               ...
               <td>可选值列表</td>
                   ...
                   <?php if(is_array($attr_data)): foreach($attr_data as $key=>$d): ?><tr id="product1">
                        <td><?php echo ($d["id"]); ?></td>
                        <td><?php echo ($d["attr_name"]); ?></td>
                        <td><?php echo ($d["category_name"]); ?></td>
                        <td><?php if($d[attr_inp] == 0): ?>输入框<?php else: ?>下拉框<?php endif; ?> </td>
                        <td> <?php if($d[attr_type] == 0): ?>手工录入 <?php else: ?>从列表中选择<?php endif; ?></td>
    ...
    <script type="text/javascript">
        ...
        function del(id){
            if(confirm('是否确认删除？')){
                ...
                window.location.href='/shop/index.php/Admin/Attribute/category_del/id/'+id;
            }
