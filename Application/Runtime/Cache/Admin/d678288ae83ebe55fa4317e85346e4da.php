                ...
                <tr>
                    ...
                    <td>
                        <select name="pid">
                            ...
                            <?php if(is_array($menu_data)): foreach($menu_data as $key=>$d): ?><option value="<?php echo ($d["id"]); ?>"><?php echo (str_repeat('&nbsp&nbsp&nbsp',$d["level"])); echo ($d["menu_name"]); ?></option><?php endforeach; endif; ?>
