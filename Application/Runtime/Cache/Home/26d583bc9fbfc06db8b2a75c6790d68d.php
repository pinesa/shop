            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="reg_form" action="" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input class="inputBg" size="25" name="captcha" id="captcha" type="text" value="" /><img onclick="this.src='/shop/index.php/Home/Login/verify/t/'+Math.random();" src='/shop/index.php/Home/Login/verify'/>
...
<script src="/shop/Public/Home/js/jquery.js" type="text/javascript"></script>
<script src="/shop/Public/Home/js/jquery.validate.js" type="text/javascript"></script>
