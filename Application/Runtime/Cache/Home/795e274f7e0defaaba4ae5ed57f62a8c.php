                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/shop/Public/Homeimages/8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">飞利浦9@9v</a><br />本店售价：<font class="f1">￥399元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/shop/Public/Homeimages/9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue"></a></li><li><a href="#" target="_blank" title="诺基亚E66">诺基亚E66</a><br />本店售价：<font class="f1">￥2298元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="/shop/Public/Homeimages/17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">夏新N7</a><br />本店售价：<font class="f1">￥2300元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
                <div class="blank5"></div>
            </div>
<link rel="stylesheet" type="text/css" href="/shop/Public/Homecss/zzsc.css">

<script type="text/javascript" class="library" src="/shop/Public/Homejs/jquery-1.8.2.min.js"></script>
<script type="text/javascript" class="library" src="/shop/Public/Homejs/jquery.colorbox-min.js"></script>
<script type="text/javascript" class="library" src="/shop/Public/Homejs/zzsc.js"></script>
            <div class="AreaR">
  ...
  <div class="con-fangDaIMg">
    <!-- 正常显示的图片-->
    <img src="/shop/Uploads<?php echo ($datas_pic[0]['pic_big']); ?>">
    <!-- 滑块-->  
    <div class="magnifyingBegin"></div>
    <!-- 放大镜显示的图片 -->
    <div class="magnifyingShow"><img src="/shop/Uploads<?php echo ($datas_pic[0]['pic_big']); ?>"></div>
  </div>
                        ...
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                          ...
                          <?php if(is_array($goods_attr)): foreach($goods_attr as $key=>$d): ?><li class="padd loop">
                                    ...
                                    <?php if(is_array($d[goods_attr_val])): foreach($d[goods_attr_val] as $k=>$dd): ?><label for="spec_value_">
                                        <input name="goods_attr[<?php echo ($d[id]); ?>][]" value="227" id="spec_value_227" <?php if($k == 0): ?>checked="checked"<?php endif; ?>  type="radio" />
                                ...
                                <li class="padd">
                                    <a href="#"><img src="/shop/Public/Homeimages/goumai2.gif"></a>
                                    <a href="#"><img src="/shop/Public/Homeimages/shoucang2.gif"></a>
                                    <a href="#"><img src="/shop/Public/Homeimages/tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                    </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/shop/Public/Homeimages/24_thumb_G_1241971981429.jpg" alt="P806" class="goodsimg"></a><br />
                                <p><a href="#" title="P806">P806</a></p> 
                                <font class="shop_s">￥2000元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/shop/Public/Homeimages/22_thumb_G_1241971076803.jpg" alt="多普达Touch HD" class="goodsimg" /></a><br />
                                <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p> 
                                <font class="shop_s">￥5999元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="/shop/Public/Homeimages/13_thumb_G_1241968002527.jpg" alt="诺基亚5320 XpressMusic" class="goodsimg" /></a><br />
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="padding-left: 15px; text-align: left; float: left;">
                                                            ...
                                                            <img src="/shop/Public/Homeimages/captcha.png" alt="captcha" onclick="this.src='captcha.php?'+Math.random()" class="captcha" />
                                                        </div>
