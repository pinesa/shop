...
<div class="header_bg">
        ...
        <?php if(is_array($order_data)): foreach($order_data as $key=>$d): ?><tr>
                                <td>
                ...
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
						...
						<?php if(is_array($lo_datas)): foreach($lo_datas as $key=>$d): ?><tr>
                                ...
                                <td><?php echo ($d["lo_name"]); ?>    <?php echo ($d["lo_address"]); ?> <?php echo ($d["lo_tel"]); ?></td>
              ...
              <div class="blank"></div>
                <div class="flowBox">
                    ...
                    <table id="shippingTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                <td valign="top"><input checked name="order_exp" value="2"  type="radio" />
                                </td>
                            ...
                            <tr>
                                <td valign="top"><input name="order_exp" value="1"  type="radio" />
                                </td>
                ...
                <div class="flowBox">
                    ...
                    <div id="ECS_ORDERTOTAL">
                        ...
                        <input src="/shop/Public/Homeimages/bnt_subOrder.gif" value="提价订单" type="submit" />
